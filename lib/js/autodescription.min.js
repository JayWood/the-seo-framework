...
p+e+h.width()+"px"):(b=p+c.width(),0>b&&(b=0),c.css(l,e+"px"),a.css("text-indent",b+"px"))))}},L:function(){var a=autodescription.b();a.focus();if(a.setSelectionRange){var b=2*a.val().length;a.setSelectionRange(b,b)}else a.val(a.val()).focus()},H:function(){var a=autodescription.b();"undefined"!==typeof a.val()&&(0<a.val().length?a.trigger("keyup",autodescription.m):a.trigger("keyup",autodescription.g))},v:function(){autodescription.l().trigger("keyup",autodescription.A)},w:function(){autodescription.b().trigger("keyup",
autodescription.g)},J:function(){autodescription.i=!1},G:function(a){var b=jQuery(a.target);b.parents(".seo-notice").slideUp(200,function(){b.remove()})},F:function(){autodescription.a+=1;3<autodescription.a&&(autodescription.a=0);jQuery.post(ajaxurl,{action:"the_seo_framework_update_counter"});autodescription.j()},j:function(){var a=autodescription.a;1==a?(autodescription.c="tsf-counter-one",autodescription.a=1):2==a?(autodescription.c="tsf-counter-two",autodescription.a=2):3==a?(autodescription.c=
"tsf-counter-three",autodescription.a=3):(autodescription.c="tsf-counter-zero",autodescription.a=0);autodescription.ba()},ba:function(){autodescription.w();autodescription.v()},f:function(a){return autodescriptionL10n[a]},ready:function(){jQuery("div.updated, div.error, div.notice-warning").insertAfter("div.top-wrap");jQuery(document.body).ready(autodescription.j);jQuery(document.body).ready(autodescription.H);jQuery(document.body).ready(autodescription.w);jQuery(document.body).ready(autodescription.v);
jQuery(document.body).ready(autodescription.W);jQuery(document.body).ready(autodescription.statusBarHover);jQuery(document.body).on("click touchstart MSPointerDown",autodescription.K);autodescription.C();jQuery(document.body).ready(autodescription.J);autodescription.l().on("keydown keyup paste",autodescription.A);autodescription.b().on("keydown keyup paste",autodescription.g);jQuery("#title-separator input").on("click",autodescription.M);jQuery("#description-separator input").on("click",autodescription.N);
jQuery(".autodescription-js-confirm-reset").on("click.autodescription.autodescription_confirm_reset",autodescription.D);jQuery(".seoframework-tab").on("click",autodescription.S);jQuery("#title-tagline-toggle :input").on("click",autodescription.U);jQuery("#title-location input").on("click",autodescription.X);jQuery("#title-prefixes-toggle :input").on("click",autodescription.Y);jQuery("#description-onblogname-toggle :input").on("click",autodescription.V);jQuery("#description-additions-toggle :input").on("click",
autodescription.B);jQuery("#autodescription-site-settings\\[homepage_title\\]").on("keydown keyup paste",autodescription.Z);jQuery("#home-title-location :input, #title-tagline-toggle :input, #title-separator input").on("click",autodescription.T);jQuery("#autodescription-site-settings\\[homepage_title_tagline\\]").on("keydown keyup paste",autodescription.u);jQuery("#autodescription-site-settings\\[title_rem_additions\\]").on("click",autodescription.aa);autodescription.b().on("keydown keyup paste",
autodescription.m);jQuery("#autodescription-title-placeholder").on("click",autodescription.L);jQuery(".autodescription-dismiss").on("click",autodescription.G);jQuery(".theseoframework-counter").on("click",autodescription.F)}};jQuery(autodescription.ready);
