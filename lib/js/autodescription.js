...
// @js_externs /** @constructor */ function autodescription() {}; autodescription.statusBarHover; /** @type {Array|string} */ var autodescriptionL10n;
// ==/ClosureCompiler==
// http://closure-compiler.appspot.com/home

/* global autodescription, statusBarHover, confirm, autodescriptionL10n  */
...
window[ 'autodescription' ] = {
	...
	taglineToggleOnload: function( event ) {
		...
		var $tagTitle = jQuery( '#title-tagline-toggle :input' ),
			...
			$descAdditions = jQuery( '#description-additionjs-js' ),
